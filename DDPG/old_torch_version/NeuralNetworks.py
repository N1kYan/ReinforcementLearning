...
class Actor(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, num_layers=2, fc1_units=400, fc2_units=300):
        """
...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, num_layers=2, fcs1_units=400, fc2_units=300):
        """
