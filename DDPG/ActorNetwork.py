...
class Actor(object):
    ...
    def create_network(self):
        ...
        h1 = Dense(self.hidden, activation='relu')(input)
        ...
        return input, nn, nn.trainable_weights

    def train(self, input, action_gradients):
        self.tensor_session.run(self.optimizing, feed_dict={self.input: input, self.merge_grad:action_gradients})
