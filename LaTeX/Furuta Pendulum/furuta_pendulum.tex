...
XX We present an overview over it's technical details and discuss algorithms to 
solve the control problem. XX
...
The Furuta pendulum is an underactuated system. This %TODO ggf neue Section 
%oder umschreiben
...
Stabilization considers the problem if the arm is nearly upright with low 
