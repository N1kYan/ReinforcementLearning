...
\begin{figure}[H]
	...
	\caption{Result of training with a gaussion noise with mean zero and standard deviation $\sigma=0.7$. The mini-batch size was also increased to 256, the other parameters were kept as before.}
