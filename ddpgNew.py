...
class ActorCriticTargets(object):
    def __init__(self, state_space, action_space, learningrate, hidden_neurons):
        ...
        self.actor_input_dim, self.actor_model, self.actor_target_model = actor.create_network()
        ...
        self.state_input, self.action_input, self.critic_model, self.critic_target_model = critic.create_network()
